                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item text-white fs-3" aria-current="page">{{ $lessonSchedule->teacherSubject->subject->name }} - {{ $lessonSchedule->classroom->name }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="table-responsive rounded-2 mb-4">
                    <table class="table text-nowrap customize-table mb-0 align-middle" id="student-table">
                        <thead class="text-dark fs-4">
                            <tr>
                                <th class="text-white rounded-start" style="background-color: #3DBCEC;">Siswa</th>
