        ...
        <div class="row align-items-center">
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-white text-decoration-none" href="javascript:void(0)">{{ auth_user()->name }}</a></li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('teacher.journals.show', $lessonSchedule->teacherJournals->first()->id) }}" class="btn btn-primary">Detail</a>
                            <a href="{{ route('teacher.journals.edit', $lessonSchedule->teacherJournals->first()->id) }}" class="btn btn-warning">Edit Jurnal</a>
                        </td>
                        @else
                        <td class="text-center"><a href="{{ route('teacher.journals.create', $lessonSchedule->id) }}" class="btn btn-primary">Isi Jurnal</a></td>
                        @endif
                    </tr>
                    @empty
                    <tr>
...
<div class="row">
    ...
    <div class="col-md-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-header bg-primary" style="border-radius: 0.50rem;">
                <h4 class="mb-0 text-white card-title">
                    X RPL 1 - Bahasa Indonesia {{-- {{ $journal->classroom->name }} - {{ $journal->teacherSubject->subject->name }} --}}
                </h4>
                    ...
                    <div class="col-lg-4">
                        <div class="ps-3">
                            ...
                            <div class="row px-5">
                                <div class="col-lg-4">
                                    <div class="text-center">
                                        <span class="badge bg-light-primary text-primary fs-7 fw-semibold mb-1 py-2">{{ $journal->attendanceJournals->where('status', AttendanceEnum::PERMIT)->count() }}</span>
                                        <p>Izin</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="text-center">
                                        <span class="badge bg-light-warning text-warning fs-7 fw-semibold mb-1 py-2">{{ $journal->attendanceJournals->where('status', AttendanceEnum::SICK)->count() }}</span>
                                        <p>Sakit</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="text-center">
                                        <span class="badge bg-light-danger text-danger fs-7 fw-semibold mb-1 py-2">{{ $journal->attendanceJournals->where('status', AttendanceEnum::ALPHA)->count() }}</span>
                                        <p>Alfa</p>
                                    </div>
                                </div>
                            </div>
