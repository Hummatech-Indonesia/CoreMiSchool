...
@section('content')
    ...
    <div class="row">
                            ...
                            <tbody>
                                @forelse (range(1, 5) as $item)
                                    <tr>
                                        ...
                                        <td>07.00</td>
                                        <td>
                                            <span class="mb-1 badge font-medium bg-light-secondary text-secondary">Masuk</span>
                                        </td>
                                    </tr>
                                @empty
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <h4>Statistik Absensi Harisn</h4>
                    <h6 class="mt-1">Tahun ini</h6>
                    <div id="chart-teacher" class="mt-5"></div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row pb-2" style="border-bottom: 1px solid #c0c0c0">
                                <div class="col-lg-8" style="border-right: 1px solid #c0c0c0;">
                                    <div class="pe-3">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vehicula lacus massa, a finibus urna hendrerit fringilla.
    ...
    <button class="btn mb-5 waves-effect waves-light btn-outline-info w-100" type="button">Lihat Selengkapnya</button>
