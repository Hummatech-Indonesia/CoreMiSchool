...
@section('content')
        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    ...
                    <h4 class="fw-semibold text-white mb-2">XI RPL 1</h4>
    ...
    <div class="col-lg-3 mb-3 mt-4">
        <form class="d-flex gap-2">
            <input type="text" class="form-control search-chat" placeholder="Cari..">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h6 class="fs-4 fw-semibold mb-0">Ahmad Lukmad Hakim</h6>
