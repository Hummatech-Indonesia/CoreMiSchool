<!-- modal detail -->
<div class="modal fade" id="modal-detail-student" tabindex="-1" aria-labelledby="importPegawai" aria-hidden="true">
        ...
        <div class="modal-content modal-lg">
            ...
            <div class="modal-body text-center">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="d-flex" style="margin-bottom: 0.5rem;">
                            <h6 style="margin-bottom: 0;">Nomer KK:</h6>
                            <p class="ms-2" style="margin-bottom: 0;" id="kknumber-detail"></p>
                        </div>
                        <hr>
                    </div>
                    <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="d-flex" style="margin-bottom: 0.5rem;">
                            ...
                            <p class="ms-2" style="margin-bottom: 0;" id="childnumber-detail"></p>
                        </div>
                        <hr>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="d-flex" style="margin-bottom: 0.5rem;">
                            <h6 style="margin-bottom: 0;">Nomer Akta:</h6>
                            <p class="ms-2" style="margin-bottom: 0;" id="numberAkta-detail"></p>
                        </div>
                        <hr>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="d-flex" style="margin-bottom: 0.5rem;">
                            ...
                            <p class="ms-2" style="margin-bottom: 0;" id="numbersibling-detail"></p>
                        </div>
                        <hr>
                    </div>
                    <div class="col-12 col-md-6">
