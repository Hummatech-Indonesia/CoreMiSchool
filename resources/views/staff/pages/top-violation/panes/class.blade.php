        ...
        <div class="col-lg-4 col-md-12">
            <div class="card position-relative">
                <div class="card-body">
                    ...
                    <div class="card mt-3 mb-0">
                        <div class="card-body py-3 px-3 bg-light-primary">
                            ...
                            <div class="d-flex gap-2 align-items-center justify-content-start">
                                ...
                                <h5>{{ $classroom->classroomStudents->sum(function($student) { return $student->point->sum(); }) }} Siswa</h5>
                                {{-- <h5>{{ $classroom->classroomStudents->reduce(function ($carry, $student) {
                                    return $carry + $student->studentViolations->count();
                                }, 0) }} --}}
                                    Siswa</h5>
                            </div>
                        </div>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('employee.violation.class-point.detail', ['classroom' => $classroom->id]) }}"
