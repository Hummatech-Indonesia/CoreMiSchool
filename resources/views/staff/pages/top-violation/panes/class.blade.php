            ...
            <div class="card position-relative">
                <div class="card-body">
                    ...
                    <div class="justify-content-between d-flex align-items-center mt-5">
                        ...
                        <div>
                            <span class="mb-1 badge font-medium bg-light-danger text-danger"> {{ $classroom->classroomStudents->sum(function($student){ return $student->student->sum('point'); }) }} Point </span>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('employee.class-violation.detail', ['classroom' => $classroom->id]) }}" class="btn btn-primary w-100">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
