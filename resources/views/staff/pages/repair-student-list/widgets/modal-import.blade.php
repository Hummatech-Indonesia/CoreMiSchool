<!-- modal import -->
<div class="modal fade" id="import-remidial" tabindex="-1" aria-labelledby="importPegawai" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importPegawai">Import Perbaikan</h5>
            ...
            <form action="{{ route('employee.student-repair.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="card p-3" style="background-color: #FFF5E3;">
                        ...
                        <div class="ms-4">
                            <a href="{{ route('employee.student-repair.download') }}" class="btn btn-primary">
