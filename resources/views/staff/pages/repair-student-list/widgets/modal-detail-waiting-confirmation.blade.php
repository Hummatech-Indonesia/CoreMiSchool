        ...
        <div class="modal-content">
            ...
            <form action="" enctype="multipart/form-data">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <div>
                        <button type="button" class="btn mb-1 waves-effect waves-light btn-light-primary" data-bs-dismiss="modal">Tutup</button>
                    </div>
                    <div>
                        <button type="button" class="btn mb-1 me-2 waves-effect waves-light btn-danger" data-bs-dismiss="modal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32"><path fill="currentColor" d="M17.414 16L24 9.414L22.586 8L16 14.586L9.414 8L8 9.414L14.586 16L8 22.586L9.414 24L16 17.414L22.586 24L24 22.586z"/></svg>
                            Tolak
                        </button>
                        <button type="button" class="btn mb-1 waves-effect waves-light btn-success" data-bs-dismiss="modal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="m10 15.17l9.192-9.191l1.414 1.414L10 17.999l-6.364-6.364l1.414-1.414z"/></svg>
                            Terima
                        </button>
                    </div>
                </div>
