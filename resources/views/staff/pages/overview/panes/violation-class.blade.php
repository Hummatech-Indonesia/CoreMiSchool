        ...
        <div class="card border h-100">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <div>
                        <h4><b>XII RPL 2</b></h4>
                        <h6>MERDEKA | 2023 - 2024</h6>
                    </div>
                    <div>
                        <h4><b>Suyadi Oke Joss</b></h4>
                        <h6 style="display: flex; align-items: center;">
                            ...
                            <span style="margin-left: 8px;">36 Siswa</span>
                        </h6>
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <div>
                        <span class="badge font-medium bg-light-danger text-danger px-4 py-2"
                            style="font-size: 18px;">100 Total Point</span>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 mt-n3 order-lg-2 order-1">
                        <div class="mt-n5">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mb-0 fs-4 mb-4">suyadi@gmail.com</p>
                                <h5 class="fs-4 mb-3 fw-semibold">Wali Kelas XII RPL 2</h5>
                            </div>
                            <div class="mx-3">
...
<div class="card w-100 position-relative overflow-hidden mt-3 border">
    <div class="card-body p-4">
        <h5 class="mb-3">Daftar Point Siswa - XXI RPL 1</h5>
