            ...
            <div class="col-lg-8">
                ...
                <div class="blog_left_side">
                    <div class="blog_panel" data-aos="fade-up" data-aos-duration="1500">
                        <div class="main_img">
                            <a href="blog-detail.html"><img src="{{ asset('landing_assets/images/new/blog-list_01.png') }}" alt="image"></a>
                        </div>
                        <div class="blog_info">
                    ...
                    {{-- <div class="blog_panel" data-aos="fade-up" data-aos-duration="1500">
                        <div class="main_img">
                            <a href="blog-detail.html"><img src="{{ asset('landing_assets/images/new/blog-list_02.png') }}" alt="image"></a>
                        </div>
                        <div class="blog_info">
                ...
                <div class="row">
                    <div class="col-lg-1">
                        <img src="{{ asset('landing_assets/images/new/blog-list_02.png') }}" alt="">
                    </div>
                    <div class="col-lg-11">
                        sghsjdgyj
                    </div>
                        ...
                        <ul class="recent_blog_list">
                            <li>
                                <a href="blog-detail.html">
                                    <div class="img">
                                        <img src="{{ asset('landing_assets/images/new/blog-side_01.png') }}" alt="image">
                                    </div>
                                    <div class="text">
