            ...
            <div class="row align-items-center">
                <div class="col-8 col-md-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item" aria-current="page">Daftar jurnal staff setelah berkegiatan di sekolah</li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="container-fluid note-has-grid">
        ...
        <ul class="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row flex-wrap" id="nav-tab" role="tablist">
            ...
            <li class="nav-item ms-auto d-flex align-items-center">
                <a href="{{ route('school.employee-journal.export') }}" type="button" class="btn btn-warning">
