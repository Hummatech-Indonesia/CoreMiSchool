    ...
    <div class="card bg-light-primary shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8" style="color: #3DBCEC">Cetak Jurnal Guru</h4>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <form id="form-action" class="row d-flex align-items-center">
                    <div class="col-lg-9 col-md-12 d-flex flex-wrap gap-2">
                    ...
                    <div class="col-lg-3 col-md-12 mt-4 d-flex justify-content-end align-items-center gap-2">
                        <div class="form-group flex-fill">
