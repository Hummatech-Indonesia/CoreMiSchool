    ...
    <table class="table border text-nowrap customize-table mb-0 align-middle text-center">
        ...
        <tfoot>
            <tr>
                <td>
                    <div>
                        <button type="button" class="btn-create btn btn-primary btn-rounded m-t-10 mb-3" data-classroom="{{ $classroom->id }}" data-day="monday">
                ...
                <td colspan="1"></td>
                @if (isset($lessonSchedules['monday']))
