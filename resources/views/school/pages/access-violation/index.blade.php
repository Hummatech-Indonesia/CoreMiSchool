                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-3">
                            <button class="border-0 bg-transparent btn-detail" data-name="{{ $user->user->name }}" data-email="{{ $user->user->email }}" data-phone="{{ $user->user->phone_number }}" data-gender="{{ $user->gender }}" data-nip="{{ $user->nip }}" data-address="{{ $user->address }}"
