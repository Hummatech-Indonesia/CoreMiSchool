                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-3">
                            <button class="btn-detail" data-name="{{ $user->user->name }}" data-email="{{ $user->user->email }}" data-phone="{{ $user->user->phone_number }}" data-gender="{{ $user->gender }}" data-nip="{{ $user->nip }}" data-address="{{ $user->address }}"
                                data-image="{{ $user->image ? asset('storage/'. $user->image) : asset('admin_assets/dist/images/profile/user-1.jpg') }}" data-rfid="{{ $user->modelHasRfid ? $user->modelHasRfid->rfid : 'Belum memiliki rfid' }}">
                            ...
                            <button class="btn-delete" data-id="{{ $user->user->id }}">
