...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex gap-2">
        <form id="form-action" class="d-flex gap-2 align-items-center ms-2">
            <input type="date" name="start_date" class="form-control" id="" value="{{ old('date', request()->start_date ?? date('Y-m-d')) }}">
            <input type="date" name="end_date" class="form-control" id="" value="{{ old('date', request()->end_date ?? date('Y-m-d')) }}">
            <button type="submit" class="btn btn-primary">Cari</button>
            <button class="btn btn-export btn-success" type="submit">
