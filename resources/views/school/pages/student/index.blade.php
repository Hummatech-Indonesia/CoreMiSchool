        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $student->modelHasRfid ? $student->modelHasRfid->rfid : '' }}
                    <button type="submit" class="btn btn-rounded btn-light-warning text-warning ms-2 btn-rfid" data-id="{{ $student->id }}" data-role="student" data-name="{{ $student->user->name }}" data-rfid="{{ $student->modelHasRfid ? $student->modelHasRfid->rfid : '-' }}">
                ...
                <td>
                    <div class="category-selector btn-group position-relative">
                        ...
                        <div class="dropdown-menu dropdown-menu-right category-menu position-absolute" style="z-index: 1050;">
                            <button class="btn-detail note-business badge-group-item badge-business dropdown-item position-relative category-business d-flex align-items-center gap-3" data-id="{{ $student->id }}" data-name="{{ $student->user->name }}" data-email="{{ $student->user->email }}" data-nisn="{{ $student->nisn }}" data-religion_id="{{ $student->religion_id }}" data-gender="{{ $student->gender }}" data-birth_place="{{ $student->birth_place }}" data-birth_date="{{ $student->birth_date }}" data-nik="{{ $student->nik }}" data-number_kk="{{ $student->number_kk }}" data-number_akta="{{ $student->number_akta }}" data-order_child="{{ $student->order_child }}" data-count_siblings="{{ $student->count_siblings }}" data-address="{{ $student->address }}" data-rfid="{{ $student->modelHasRfid ? $student->modelHasRfid->rfid : 'Tidak ada' }}" data-image="{{ $student->image ? asset('storage/' . $student->image) : asset('admin_assets/dist/images/profile/user-1.jpg') }}">
                                <i class="fs-4 ti ti-eye"></i>Detail
                            </button>
                            <button class="note-business badge-group-item badge-business dropdown-item position-relative category-business d-flex align-items-center gap-3 btn-edit" data-id="{{ $student->id }}" data-name="{{ $student->user->name }}" data-email="{{ $student->user->email }}" data-nisn="{{ $student->nisn }}" data-religion_id="{{ $student->religion_id }}" data-gender="{{ $student->gender }}" data-birth_place="{{ $student->birth_place }}" data-birth_date="{{ $student->birth_date }}" data-nik="{{ $student->nik }}" data-number_kk="{{ $student->number_kk }}" data-number_akta="{{ $student->number_akta }}" data-order_child="{{ $student->order_child }}" data-count_siblings="{{ $student->count_siblings }}" data-address="{{ $student->address }}"><i class="fs-4 ti ti-edit"></i>Edit
                            </button>

                            <button class="note-business badge-group-item badge-business dropdown-item text-danger position-relative category-business d-flex align-items-center gap-3 btn-delete" data-id="{{ $student->id }}"><i class="fs-4 ti ti-trash"></i>Hapus
                            </button>
                        </div>
                    </div>
                </td>
