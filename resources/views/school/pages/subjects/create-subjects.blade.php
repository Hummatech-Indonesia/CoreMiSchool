        ...
        <div class="col-lg-3">
            <div class="card card-body bg-transparent border-2 shadow-none">
                <div class="text-center">
                    <h5>{{$maple->name}}</h5>
                    <div class="mt-4">
                        <button type="button" class="btn btn-edit mb-1 btn-primary px-4 me-2" data-id="{{ $maple->id }}" data-name="{{ $maple->name }}" data-religion="{{ $maple->religion_id }}">
                            Edit
                        </button>
                        <button type="button" class="btn btn-delete mb-1 btn-light-danger text-danger px-4" data-id="{{ $maple->id }}">
                            Hapus
                        </button>
                    </div>
                </div>
