    ...
    <table class="table border text-nowrap customize-table mb-0 align-middle text-center">
        ...
        <tfoot>
            <tr>
                <td>
                    <div>
                        <button type="button" data-id="{{ $latestHour[0][0]->id }}" data-day="{{ $latestHour[0][0]->day }}" data-name="{{ $latestHour[0][0]->name }}" data-start="{{ $latestHour[0][0]->end }}" class="btn-create btn btn-info btn-rounded m-t-10 mb-3">
