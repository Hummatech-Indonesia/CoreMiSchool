...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                    <form method="GET" action="{{ route('presence-student.export-preview', $classroom->id) }}" class="d-flex col-12 col-md-6">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-warning ms-2 mt-1">
