                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        <div class="bg-light-success text-success d-inline-block px-3 py-3 rounded">
                            <svg width="40" height="40" viewBox="0 0 37 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 0V2.9H31.3077V26.1H11.3846V29H37V26.1H34.1538V0H0ZM5.69515
                                ...
                                17.5667L14.2336 20.2739L9.82777 17.9046C9.21288 17.5736 8.52804 17.4004 7.83261 17.4H0Z" fill="#13DEB9"/>
                            </svg>
                        </div>
                        <div class="ms-4">
                            <h4 class="card-title text-dark"><b>Jumlah Guru</b></h4>
                            <h6 style="font-size: 25px; color: #13DEB9"><b>{{$teachers->count()}}</b></h6>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="bg-light-warning text-warning d-inline-block px-3 py-3 rounded">
                            <svg width="40" height="40" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.8008 18.0807C16.301 18.0807 14.8348 17.636 13.5878
