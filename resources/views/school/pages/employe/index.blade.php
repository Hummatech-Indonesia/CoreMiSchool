    ...
    <div class="col-lg-6 mb-3">
        <form class="d-flex gap-2">
            <div class="position-relative">
                <div class="">
                    <input type="text" name="search" class="form-control search-chat py-2 px-5 ps-5" id="search-name" placeholder="Cari" value="{{ old('search', request('search')) }}">
                ...
                <td>
                    <div class="category-selector btn-group position-relative">
                        ...
                        <div class="dropdown-menu dropdown-menu-right category-menu position-absolute" style="z-index: 1050;">
                            <button class="btn-detail note-business badge-group-item badge-business dropdown-item position-relative category-business d-flex align-items-center gap-3" data-id="{{ $staff->id }}" data-name="{{ $staff->user->name }}" data-email="{{ $staff->user->email }}" data-gender="{{ $staff->gender }}" data-status="{{ $staff->active }}" data-nip="{{ $staff->nip }}" data-nik="{{ $staff->nik }}" data-birth_date="{{ $staff->birth_date }}" data-birth_place="{{ $staff->birth_place }}" data-phone="{{ $staff->phone_number }}" data-address="{{ $staff->address }}" data-religion="{{ $staff->religion_id }}" data-rfid="{{ $staff->modelHasRfid ? $staff->modelHasRfid->rfid : 'Tidak ada' }}" data-image="{{ $staff->image ? asset('storage/' . $staff->image) : asset('admin_assets/dist/images/profile/user-1.jpg') }}">
                                <i class="fs-4 ti ti-eye"></i>Detail
                            </button>
                            <button type="button" class="btn-edit note-business badge-group-item badge-business dropdown-item position-relative category-business d-flex align-items-center gap-3" data-id="{{ $staff->id }}" data-name="{{ $staff->user->name }}" data-email="{{ $staff->user->email }}" data-gender="{{ $staff->gender }}" data-status="{{ $staff->active }}" data-nip="{{ $staff->nip }}" data-nik="{{ $staff->nik }}" data-birth_date="{{ $staff->birth_date }}" data-birth_place="{{ $staff->birth_place }}" data-phone="{{ $staff->phone_number }}" data-address="{{ $staff->address }}" data-religion="{{ $staff->religion_id }}">
        ...
        <div class="modal-content modal-lg">
            ...
            <div class="modal-body text-center">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <img id="image-detail" src="{{ asset('admin_assets/dist/images/profile/user-1.jpg') }}" class="rounded-circle user-profile mb-3" style="object-fit: cover; width: 150px; height: 150px;" alt="User Profile Picture" />
                    </div>
                </div>
                <div class="row mt-3">
...
<script>
    ...
    function editpreviewFile() {
        ...
        const file = document.getElementById('editimageInput').files[0];
        const reader = new FileReader();
