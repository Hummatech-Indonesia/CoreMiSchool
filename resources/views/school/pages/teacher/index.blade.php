                    ...
                    <tr>
                        ...
                        <td>
                            <div class="category-selector btn-group">
                                <button class=" nav-link category-dropdown label-group p-0" data-bs-toggle="dropdown"
                                ...
                                <div class="dropdown-menu dropdown-menu-right category-menu"
                                    ...
                                    <button
                                        ...
                                        data-email="{{ $teacher->user->email }}" data-gender="{{ $teacher->gender }}"
                                        data-status="{{ $teacher->active }}" data-nip="{{ $teacher->nip }}"
                                        data-nik="{{ $teacher->nik }}" data-birth_date="{{ $teacher->birth_date }}"
                                        data-birth_place="{{ $teacher->birth_place }}"
                                        data-phone="{{ $teacher->phone_number }}" data-address="{{ $teacher->address }}"
                                        data-religion="{{ $teacher->religion_id }}"
                                        data-rfid="{{ $teacher->modelHasRfid ? $teacher->modelHasRfid->rfid : 'Tidak ada' }}"
                                        data-maple="{{ $teacher->teacherMaples ? $teacher->teacherMaples->count() : '0' }}"
                                        data-image="{{ $teacher->image ? asset('storage/' . $teacher->image) : asset('admin_assets/dist/images/profile/user-1.jpg') }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    <div class="">
                        <div class="wizard-content">
                            <form id="form-edit" class="tab-wizard wizard-circle wizard clearfix" role="application"
