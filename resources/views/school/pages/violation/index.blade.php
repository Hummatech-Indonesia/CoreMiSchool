...
@section('content')
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-flex justify-content-between mb-2">
                                <h5 class="fw-semibold text-white mb-8">Maks point pada sekolah</h5>
                            ...
                            <nav aria-label="breadcrumb">
                                <span class="badge fw-semibold fs-6 text-warning bg-white p-2">{{ $maxPoint->max_points }}
                                    Point</span>
                            </nav>
                        </div>
                    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-warning d-flex align-items-center" type="button" data-bs-toggle="modal"
                data-bs-target="#modal-max-point">
