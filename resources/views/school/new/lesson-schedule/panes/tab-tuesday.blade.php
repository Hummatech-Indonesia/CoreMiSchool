...
<div class="table-responsive rounded-2">
    <table class="table border text-nowrap customize-table mb-0 align-middle text-center">
        ...
        <tbody>
            @forelse (isset($lessonSchedules['tuesday']) ? $lessonSchedules['tuesday'] : [] as $lessonSchedule)
                <tr>
        ...
        <tfoot>
            <tr>
                <td>
                    <div>
                        <button type="button" class="btn-create btn btn-info btn-rounded m-t-10 mb-3" data-classroom="{{ $classroom->id }}" data-day="{{ isset($lessonHours['tuesday']) ? $lessonHours['tuesday']->first()->day : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
