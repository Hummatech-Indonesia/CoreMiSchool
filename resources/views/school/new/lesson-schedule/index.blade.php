                ...
                <div class="position-relative">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h4 class="mb-2"><b>12 RPL 1</b></h4>
                            <div class="d-flex align-items-center">
                                <span class="mb-1 badge font-medium bg-light-primary text-primary fs-3">2021/2022</span>
                            </div>
                        </div>
                        ...
                        <a href="/new/school/lesson-schedule/detail" class="btn waves-effect waves-light btn-primary w-100">Masuk Kelas</a>
                    </div>
                </div>
            </div>
        </div>
