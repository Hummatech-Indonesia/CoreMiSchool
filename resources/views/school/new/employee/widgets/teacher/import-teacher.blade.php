    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importPegawai">Import Guru</h5>
                    ...
                    <div class="card p-3" style="background-color: #FFF5E3;">
                        ...
                        <div>
                            <ul style="list-style-type: disc;" class="ms-4">
                                <li>Jika guru tidak terimport maka kemungkinan email guru tersebut telah digunakan.
                                </li>
                        ...
                        <div class="ms-4">
                            <a href="{{ route('school.teacher.download-template') }}" class="btn btn-primary">
