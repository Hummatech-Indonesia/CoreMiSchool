...
@section('content')
    ...
    <ul class="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-semesters-tab" data-bs-toggle="pill" href="#pills-semesters" role="tab"
        ...
        <li class="nav-item ms-auto">
            <a href="javascript:void(0)" class="btn btn-primary d-flex align-items-center px-3" data-bs-toggle="modal"
