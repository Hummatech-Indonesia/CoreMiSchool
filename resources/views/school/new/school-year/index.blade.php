...
{{-- <ul class="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row" id="pills-tab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="pills-school-year-tab" data-bs-toggle="pill" href="#pills-school-year" role="tab" aria-controls="pills-school-year" aria-selected="true">
    ...
    <li class="nav-item">
        <a class="nav-link" id="pills-semesters" data-bs-toggle="pill" href="#pills-semesters" role="tab" aria-controls="pills-semesters" aria-selected="false">
...
<div class="tab-content mt-4" id="pills-tabContent">
    <div class="tab-pane fade show active" id="pills-school-year" role="tabpanel" aria-labelledby="pills-school-year-tab">
      @include('school.new.school-year.panes.tab-school-year')
    </div>
    <div class="tab-pane fade" id="pills-semesters" role="tabpanel" aria-labelledby="pills-semesters">
