<div class="card card-body">
    ...
    <ul class="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="pills-ganjil-tab" data-bs-toggle="pill" href="#pills-ganjil" role="tab" aria-controls="pills-ganjil" aria-selected="true">
                Ganjil
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="pills-genap-tab" data-bs-toggle="pill" href="#pills-genap" role="tab" aria-controls="pills-genap" aria-selected="false">
                Genap
            </a>
        </li>
    </ul>
