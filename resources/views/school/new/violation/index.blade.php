            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="justify-content-between d-flex align-items-center"> 
                        <div><h6>Ditambahkan pada :</h6></div>
                        <div class="d-flex">
                            ...
                            <div class="category-selector btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-end category-menu overflow-auto" style="max-height: 200px;">
                                    <button type="button" data-id="{{ $regulation->id }}" data-violation="{{ $regulation->violation }}" data-point="{{ $regulation->point }}" class="btn-update note-business badge-group-item badge-business dropdown-item position-relative category-business d-flex align-items-center">
                                        Edit
                                    </button>
                    ...
                    <div class="justify-content-between d-flex mt-4 align-items-center">
                        ...
                        <span class="mb-1 badge font-medium bg-light-danger text-danger">+ {{ $regulation->point }} point</span>
                    </div>
                </div>
            </div>
        </div>
