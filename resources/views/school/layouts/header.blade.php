<header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset('assets/images/logo/logo-miscool.png') }}" class="dark-logo" width="180" alt="" />
            <img src="{{ asset('assets/images/logo/logo-miscool.png') }}" class="light-logo" width="180" alt="" />
        </div>
