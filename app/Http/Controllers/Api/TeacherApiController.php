...
class TeacherApiController extends Controller
{
    ...
    public function teacher_attendance(User $user)
    {
        ...
        $data = [
            ...
            'check_in' => $todayAttendance->checkin == null ? '-' : Carbon::parse($todayAttendance->checkin)->format('H:i'),
            'check_out' => $todayAttendance->checkout == null ? '-' : Carbon::parse($todayAttendance->checkout)->format('H:i'),
